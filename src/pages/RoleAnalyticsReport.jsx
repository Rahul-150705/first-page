                        ...
                        <section className="bg-gray-800/80 p-10 rounded-[2.5rem] border border-gray-700 shadow-xl space-y-8">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {report.aggregatedMissingSkills.map(skill => (
                                    <span key={skill} className="bg-red-500/10 text-red-500 px-5 py-2.5 rounded-2xl text-sm font-black border border-red-500/20 uppercase tracking-tighter">
                                        {skill}
                                    </span>
                                ))}
                            </div>
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="space-y-4">
                                {report.topRecommendedCourses.map((c, idx) => (
                                    <div key={idx} className="bg-gray-800/80 p-6 rounded-3xl border border-gray-700 hover:border-blue-500/30 transition-all group flex gap-5 shadow-lg">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black uppercase text-gray-500 mb-1 tracking-widest">{c.platform}</p>
                                            <h4 className="font-bold group-hover:text-blue-400 transition-colors uppercase leading-tight text-sm">{c.courseName}</h4>
                                        </div>
                                    </div>
                                ))}
                            </div>
