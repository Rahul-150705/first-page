        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
            ...
            >
                <div className="text-center">
                    ...
                    <h2 className="text-4xl font-black text-gray-900 uppercase tracking-tighter">Student Join</h2>
                    <p className="text-gray-400 mt-2">Start your AI-driven career journey today.</p>
                </div>
                ...
                <p className="text-center text-gray-400 font-medium">
                    Already registered? <Link to="/student/login" className="text-orange-500 font-black hover:underline uppercase tracking-widest text-xs">Student Login</Link>
                </p>
                <div className="text-center">
